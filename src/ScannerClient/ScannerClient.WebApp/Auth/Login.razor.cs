...
namespace ScannerClient.WebApp.Auth;

[Route($"/{ScannerUrls.Login}")]
public partial class Login
{
    ...
    private async Task LoginUserAsync(string userName, string password)
    {
        ...
        await _authActionService.LoginUserAsync(loginResult.AuthToken, ScannerUrls.WorkflowList, userName);
    }
