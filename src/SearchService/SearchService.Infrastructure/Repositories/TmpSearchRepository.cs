...
public class TmpSearchRepository
{
    #region MyRegion
    ...
    public TmpSearchRepository(TDocEFDbContext context)
    {
        _context = context;
    ...
    private IQueryable<object> SetOrderBy(IList<OrderByArgs> orderByFields,
    ...
    private IQueryable<object> SetSelectedFields(IList<SelectedFieldArgs> selectedFields,
        ISearchSpecification<object> specification,
        IQueryable<object> query)
    {
    ...
    private static List<DynamicProperty> GetSelectedFieldsProperties(Type entity,
    ...
    private static Expression GetBodyExpression(Type entity, ParameterExpression parameter,
        ISearchSpecification<object> specification,
    ...
    private static Expression CreateNestedSelectedExpression(Type entity,
        ParameterExpression parameter, string selectedField)
    {
        string[] fields = selectedField.Split('.');
